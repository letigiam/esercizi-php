...
<form>
        ...
        <div id="section"> 
            ...
            <input type="text" name="numInput1" class="form-control" placeholder="Inserisci il numero">
            <input type="text" name="numInput2" class="form-control" placeholder="Inserisci il numero">
